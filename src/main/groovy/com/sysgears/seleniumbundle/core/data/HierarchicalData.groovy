...
class HierarchicalData extends AbstractTestData {
     ...
     * {@link Query}, {@link Find} annotations defined on the method, identifies specific data entries in the sub-sets
     * by {@link Locator}. Returns selected data entries as an Object[][].
     *
