...
class MongoService {
    ...
    /**
     * Imports multiple mongo collections to Json file. Depending on flag keepOtherCollections drops database
    ...
    /**
     * Exports single mongo collection to Json file.
     *
    ...
    /**
     * Imports single mongo collection from Json file. Drops collection in order to get clear state before import.
     *
    ...
    /**
     * Returns list of collections names from a specific mongo dump.
     *
